...
from core.enhanced_screen_capture import EnhancedScreenCapture
from core.advanced_input_capture import InputRecorder
from core.intelligent_learning_engine import IntelligentLearningEngine
from core.enhanced_vision_system import EnhancedVisionSystem
from core.dynamic_automation_creator import DynamicAutomationCreator
from core.autonomous_play_system import AutonomousPlaySystem
from core.gameplay_recording_system import GameplayRecordingSystem

# Optional advanced SerpentAI imports (available when dependencies met)
try:
    from core.game_frame import GameFrame
    from core.game_frame_buffer import GameFrameBuffer
    from core.window_controller import WindowController
    SERPENT_CORE_AVAILABLE = True
except ImportError:
    SERPENT_CORE_AVAILABLE = False
...
class GameBot:
    ...
    def __init__(self):
        ...
        # Initialize enhanced screen capture system
        self.enhanced_screen_capture = EnhancedScreenCapture()
        
        # Initialize advanced input recorder system  
        self.input_recorder = InputRecorder()
        
        # Initialize intelligent learning engine
        self.intelligent_learning_engine = IntelligentLearningEngine()
        self.intelligent_learning_engine.start_continuous_learning()
        
        # Initialize enhanced vision system
        self.enhanced_vision_system = EnhancedVisionSystem()
        
        # Initialize gameplay recording system
        self.gameplay_recording = GameplayRecordingSystem(enhanced_vision=self.enhanced_vision_system)
        
        # Initialize dynamic automation creator
        self.dynamic_automation = DynamicAutomationCreator(
            enhanced_vision=self.enhanced_vision_system,
            automation_engine=self.automation_engine,
            learning_system=self.learning_system,
            gameplay_recorder=self.gameplay_recording
        )
        
        # Initialize autonomous play system
        self.autonomous_play = AutonomousPlaySystem(
            enhanced_vision=self.enhanced_vision_system,
            automation_engine=self.automation_engine,
            learning_system=self.learning_system,
            gameplay_recorder=self.gameplay_recording
        ...
        # Initialize advanced SerpentAI components (if available)
        if SERPENT_CORE_AVAILABLE:
            self.window_controller = WindowController()
            self.game_frame_buffer = GameFrameBuffer()
        else:
            self.window_controller = None
            self.game_frame_buffer = None
            
        # Initialize advanced RL algorithms (available but not auto-started)
        self.advanced_rl_available = {
            'deep_q_network': True,
            'proximal_policy_optimization': True, 
            'deep_deterministic_policy_gradient': True,
            'd3dshot_capture': True,
            'serpent_image_processing': True,
            'serpent_core_components': SERPENT_CORE_AVAILABLE
        }
